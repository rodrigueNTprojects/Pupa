...
const binding_grammarLexer_1 = require("../antlr/binding_grammarLexer");
const binding_grammarParser_1 = require("../antlr/binding_grammarParser");
const BindingPolicyParser_1 = require("./BindingPolicyParser");
const DataStructures_1 = require("./DataStructures");
const policy2solEJS = fs.readFileSync(path.join(__dirname, "../../../../templates") + "/policy2sol.ejs", "utf-8");
...
exports.generatePolicy = (policyStr, policyName) => {
    return new Promise((resolve, reject) => {
        try {
            ...
            let visitor = new BindingPolicyParser_1.BindingVisitor();
            visitor.visit(tree);
            ...
            reject(new DataStructures_1.Policy());
        }
    });
};
//# sourceMappingURL=BindingPolicyGenerator.js.map